...
import com.example.visiontranslator.databinding.FragmentPreviewOriginalTextBinding
import javax.inject.Inject

class PreviewOriginalTextFragment : Fragment() {

    companion object {
        fun newInstance(): PreviewOriginalTextFragment =
            PreviewOriginalTextFragment().apply {
    ...
    private lateinit var binding: FragmentPreviewOriginalTextBinding
    ...
    ): View? = FragmentPreviewOriginalTextBinding.inflate(inflater, container, false)
        .also {
            binding = it
            binding.let { binding ->
    ...
    private fun setupEditText() {
        viewModel.editModeOriginalText.observe(viewLifecycleOwner) {
            // キーボードの表示
