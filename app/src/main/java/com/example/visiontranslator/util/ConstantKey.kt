...
object ConstantKey {
    ...
    object ErrorMsg {
        ...
        const val ERROR_GOOGLE_VISION_API = "Error: at Response of Google Vision API.\nMaybe API Service already have finished."
        const val ERROR_GAS_REQUEST_ERROR = "ERROR: at Response of GAS API."
        const val ERROR_NO_IMAGE = "ERROR: No Image Selected."
        const val ERROR_NO_TEXT = "ERROR: No Text Detected !! Please use the picture has sentence."
    }
}
